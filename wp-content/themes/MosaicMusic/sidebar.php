<div class="sidecont rightsector">
    ...
    <?php if(get_theme_option('video') != '' && is_page('24')) {
    		?>
    		<div class="sidebarvideo">
    			<ul> <li><?php if(is_page('2')) {?><h2 style="margin-bottom: 7px;">Featured Video</h2><?php } ?>
        ...
        <?php if(get_theme_option('video-artist') != '' && is_page('2')) {
    		...
    		<div class="sidebarvideo">
    			<ul> <li><?php if(is_page('2')) {?><h2 style="margin-bottom: 7px;">Featured Video</h2><?php } ?>
    			<object width="284" height="240"><param name="movie" value="http://www.youtube.com/v/<?php echo get_theme_option('video-artist'); ?>&hl=en&fs=1&rel=0&border=1"></param>
    				<param name="allowFullScreen" value="true"></param>
    				<param name="allowscriptaccess" value="always"></param>
    				<embed src="http://www.youtube.com/v/<?php echo get_theme_option('video-artist'); ?>&hl=en&fs=1&rel=0&border=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="284" height="240"></embed>
    			</object>
    			</li>
    			</ul>
    		</div>
