...
if(isset($_POST['submit'])) {
    ...
    $db->query($query);
    echo '<div class="mms_save_settings" align="center">Settings successfully saved.</div>';
}
...
&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" class="mms_radio" <?php $checked = ($mms_config[0]['top_albums'] == 1)? 'checked="checked"':''; echo $checked; ?> name="top_albums" id="top_albums" value="1"><span class="mms_label"> Use Custom Data</span><br />
